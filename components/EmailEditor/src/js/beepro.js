...
import $ from 'jquery';
export const showDevicesDropdown = function (type) {
  $('.devices-list').hide();
  $('.devices-list.' + type).show();

  $('.header-dropdown.devices-menu').removeClass('hide');
};
export const hideDevicesDropdown = function () {
  $('.header-dropdown.devices-menu').addClass('hide');
};

// show/hide main menu
export const showMainMenuDropdown = function () {
  // change icon
...
export const hideMainMenuDropdown = function () {
  // change icon
...
// show alert
export const beeAlertTimeout = null;
export const beeAlert = function (title, msg) {
...
export const goToSecondPage = function () {
  // change icon
  var icon =
...
export const goToThirdPage = function () {
  // change icon
  var icon =
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512"><path fill="#626262" d="M80 96h352v32H80z"/><path fill="#626262" d="M80 240h352v32H80z"/><path fill="#626262" d="M80 384h352v32H80z"/></svg>';
  $('.menu-button.left-menu i').html(icon);
...
export const goToMainPage = function () {
  // change icon
  var icon =
...
export const goToListFieldsPage = function () {
  $('.second-page').hide();
...
export const goToGlobalTagsPage = function () {
  $('.second-page').hide();
...
export const showHtmlWidgetsPage = function () {
  $('.second-page').hide();
  $('.second-page.html-widgets').show();
};
export const goToHtmlWidgetsPage = function () {
  showHtmlWidgetsPage();

  // slide to second page
  goToSecondPage();
};
export const goToSwitchTemplatePage = function () {
  $('.second-page').hide();
...
export const hideDropup = function () {
...
export const clickIframe = function () {
  // hide all dropup
  hideDropup();
};
...
$(document).ready(function () {
  ...
  $(document).on('change keyup', 'input.main-search', function () {
    $(this)
      .closest('.main-search-group')
      .find('.not-item-search')
      .removeClass('hide');
  });
  ...
  $(document).on(
    'click',
    '.beepro-sidebar.is-second-page .menu-button.left-menu, .beepro-sidebar.is-third-page .menu-button.left-menu',
    function () {
      hideMainMenuDropdown();
      goToMainPage();
    }
  ...
  $(document).on(
    'click',
    '.beepro-sidebar.is-main-page .menu-button.left-menu',
    function () {
      hideMainMenuDropdown();
  ...
  $(document).on('keyup change', '.widget-search', function () {
    ...
    if (empty) {
      $('.widgets-container').append(
        '<p class="my-1 mx-2 not-item-search">No items found!</p>'
      );
    }
  });
  ...
  $(document).mouseup(function (e) {
    var container = $(
      '.footer-dropup, .dropup-button, .menu-button, .header-dropdown'
    );
